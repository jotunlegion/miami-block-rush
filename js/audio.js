...
(function () {
  ...
  const sfx = {
    ...
    clear(n) { if (!ac) return; const t = now(); for (let i = 0; i < Math.min(4, n); i++) tone(t + i * 0.045, 659 * Math.pow(1.335, i), 0.11, 0.22, 'p25', sfxBus); noise(t, 0.28, 0.25, 'highpass', 4000, sfxBus, 9000); },
